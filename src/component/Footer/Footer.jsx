...
const Footer = () => {
  return (
      <footer className=" xxs:w-full  xxs:max-w-full mx-auto px-10 lg:px-20 xl:px-32 pt-12 pb-3 bg-green-700 text-sm text-white dark:border dark:border-green-600 dark:border-b-1 dark:border-t-0 dark:border-x-0">
