...
const Footer = () => {
  return (
      <footer className=" border border-red-600 w-full  max-w-screen-xl mx-auto px-10 lg:px-20 xl:px-32 pt-12 pb-3 bg-green-700 text-sm text-white dark:border dark:border-green-600 dark:border-b-1 dark:border-t-0 dark:border-x-0">
