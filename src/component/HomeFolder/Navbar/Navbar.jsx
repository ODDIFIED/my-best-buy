...
const Navbar = () => {
  ...
  return (
    <div className="  dark:bg-gray-900  dark:text-white duration-200 w-full xl fixed z-40 dark:border  dark:border-green-600 dark:border-b-1 dark:border-t-0 dark:border-x-0">
